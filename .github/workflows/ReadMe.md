...
Optionally, you may edit "whitelist.txt", which contains regex expressions of files that will NOT be included in the released mod folder (eg psd files)

* Borrowed from Wisp's Starsector IntelliJ template: https://github.com/wispborne/Starsector-IntelliJ-Template
